...
var Engine = (function (global) {
    ...
    function lostGame() {
        ...
        function addNewEnemies() {
            counter = 0;
            while (counter < 4) {
                chanceNumber = randomNumberGenerator(140);
                ...
                if (chanceNumber === 1 && allEnemies.length < 8 && distanceCheck.length == 0) {
                    ...
                    randomEnemy.speed = chanceNumber * 280;
    ...
    let renderDelay = 0;
        ...
        let cc = doc.getElementById('canvascontainer');
	...
	e.target.removeEventListener(e.type, arguments.callee);
            ...
            startButton.innerHTML = "Restart Game";
             ...
             startButton.addEventListener('click', handler2);
